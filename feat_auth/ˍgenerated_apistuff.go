...
const ___yo_authChangePasswordPasswordOldPlain = q.F("PasswordOldPlain")
const ___yo_authLoginEmailAddr = q.F("EmailAddr")
const ___yo_authLoginPasswordNewPlain = q.F("PasswordNewPlain")
const ___yo_authLoginPasswordOldPlain = q.F("PasswordOldPlain")
const ___yo_authRegisterEmailAddr = q.F("EmailAddr")
const ___yo_authRegisterPasswordNewPlain = q.F("PasswordNewPlain")
const ___yo_authRegisterPasswordOldPlain = q.F("PasswordOldPlain")
